...
import profileImage from "../assets/kosal_profile.jpg";
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-3 space-y-6 lg:space-y-8">
              ...
              >
                ...
                functionality. Specialized in building modern app and web
              ...
              >
                {["GitHub", "LinkedIn"].map((platform) => {
                  const urls = {
                    GitHub: "https://github.com/ChinKosal",
                    LinkedIn:
                      "https://www.linkedin.com/in/kosal-chin-a27a37266/",
                  };
